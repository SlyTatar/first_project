...
Результат
Финальный вариант файла README.md можно посмотреть по ссылке.

 

Полезные ссылки
Расширение VS Code для работы с Markdown: https://marketplace.visualstudio.com
Библиотека эмодзи: https://emojipedia.org/
Шпаргалка по эмодзи: https://github.com/ikatyang/emoji-cheat-sheet
Статья на тему Markdown: https://skillbox.ru/media/code/yazyk-razmetki-markdown-shpargalka-po-sintaksisu-s-primerami/
Документация по Markdown на GitHub: https://docs.github.com/en/get-started/writing-on-github
